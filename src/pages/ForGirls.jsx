    ...
    <>
      ...
      <section className="hero-redesign" id="for-girls-hero">
        <div className="hero-bg-slider">
          <div className="hero-slide active" style={{ backgroundImage: "url('/img/girls-hero.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
